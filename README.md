...
* Distinguishing between groups using normal random effects that sum to zero: why and how is [here](https://htmlpreview.github.io/?https://github.com/ChrisHIV/teaching/blob/main/other_topics/normal_sum_to_zero_vector.html) (the underlying R markdown file is [here](other_topics/normal_sum_to_zero_vector.Rmd)).
