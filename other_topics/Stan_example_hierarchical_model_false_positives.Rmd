...
You can see this isn't very helpful!
This is related to the unhelpful dichotomisation of effects existing or not.
Its better to think about how good is the estimation of group effects (or conversely how bad is the overfitting to noise, both continuous) as a function of where this ratio is between 0 and 1.
The closer it is to 0, the worse the Frequentist sequential model will overfit to noise (I picked a small value to illustrate this).
